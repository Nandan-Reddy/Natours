...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibmFuZGFucmVkZHkiLCJhIjoiY2t2ZjhmMGgzMTBpaTJvcTVwMWRrZzRidSJ9.tyWG1xECczYsigK33DfVZw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/nandanreddy/ckvf91uwj4u6u18rspsnrgxqk',
    scrollZoom: false //   center: [-115, 36],
    //   zoom: 4,
    //   interactive: false
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, " :").concat(loc.description, "</p>")).addTo(map); //Extend the map bounds to include currnet location
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            // alert(err.responese.data.message);
...
var stripe = Stripe('pk_test_51JyduYSHUzYYGjXYEk0noLi4ZplJfBR5gleiZ12fH9fyB5vhbfmgcqshTGbBOM5bZxJgpnEcSKXKenBtaA4MPggg00wTso5lLC');
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    // console.log('Hello form login form');
